...
export const integrationTypeEnum = pgEnum('integration_type', ['dentrix', 'dentalintel', 'adp', 'eaglesoft']);
...
export type IntegrationType = 'dentrix' | 'dentalintel' | 'adp' | 'eaglesoft';
